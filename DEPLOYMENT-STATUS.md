...
- Environment: `REACT_APP_BACKEND_URL=https://travel-web-handoff.preview.emergentagent.com`
...
## 🔄 **API Routing**
- Frontend calls: `/api/*` → Proxied to `https://travel-web-handoff.preview.emergentagent.com/api/*`
