      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
            ...
            <Card className="relative bg-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <CardContent className="p-8">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="flex items-center">
                    <Star className="w-5 h-5 mr-2 text-yellow-500" />
                    <span className="text-sm font-medium">Marriott Preferred Agency</span>
                  </div>
                  <div className="flex items-center">
                    <Star className="w-5 h-5 mr-2 text-yellow-500" />
          ...
          <div className="text-center">
            <p className="text-gray-600 mb-6" style={{ fontFamily: 'Lato, sans-serif' }}>
              Not sure which path is right for you? No problem – schedule a free consultation to explore your options.
            </p>
            <Button
              variant="outline"
              size="lg"
