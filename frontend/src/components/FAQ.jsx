        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 text-center bg-white rounded-2xl p-8 shadow-lg">
            ...
            <p className="text-sm text-gray-500 mt-4">
              Contact: {mockData.contact.phone} | {mockData.contact.email}
            </p>
          </div>
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-700">
                Monthly memberships are non-refundable. Annual memberships can be refunded within 3 days if no discounts have been used.
              </p>
            </div>
