...
export const mockData = {
    ...
    membership: [
      {
        ...
        description: "Sign up for monthly ($150) or annual ($1500) membership",
        icon: "UserPlus"
      },
      {
        step: 2,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "Monthly Membership: $150/month (flexible membership). Annual Membership: $1500/year (Best Value - Save $300 vs monthly)."
    },
    {
