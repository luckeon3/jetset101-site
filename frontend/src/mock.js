...
export const mockData = {
  ...
  howItWorks: {
    membership: [
      {
        ...
        description: "Sign up for monthly ($99) or annual ($1,000) membership",
        icon: "UserPlus"
      },
      {
        step: 2,
    ...
    advisor: [
      ...
      },
      {
        ...
        description: "Keep 70% of all commissions with reliable payment systems",
        icon: "DollarSign"
      }
    ]
  },
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "Monthly Membership: $99/month (requires 6-month initial commitment). Annual Membership: $1,000/year (Best Value - Save $188 vs monthly)."
    },
    {
  ...
  stats: [
    ...
    { number: "70%", label: "Advisor Commission" },
