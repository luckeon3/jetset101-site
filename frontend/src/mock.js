...
export const mockData = {
    ...
    membership: [
      {
        ...
        description: "Sign up for 6-month ($99/month) or annual ($83/month) membership - flexible pricing!",
        icon: "UserPlus"
      },
      {
        step: 2,
  ...
  stripePaymentUrl: {
    sixMonth: "https://buy.stripe.com/00waEYdZy9vaap93CadfG08",
    annual: "https://buy.stripe.com/28EeVeaNmbDibtd2y6dfG09"
  },
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "6-Month Membership: $99/month (billed bi-annually). Annual Membership: $83/month (billed annually - Best Value!)."
    },
    {
