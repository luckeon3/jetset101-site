...
export const mockData = {
    ...
    advisor: [
      {
        ...
        description: "Master travel industry skills through our certification program",
        icon: "BookOpen"
      },
      {
        step: 2,
  ...
  pricing: {
    monthly: {
      ...
      reconnectionFee: 499,
      period: "Monthly Plan",
      commitment: "$499 registration fee + $49/month ongoing",
      reconnectionPolicy: "Includes $499 reconnection fee if membership lapses"
    },
    allinone: {
      price: 997,
      period: "All-In-One Plan", 
      commitment: "$997 one-time annual payment",
      reconnectionPolicy: "No reconnection fee required"
    }
  },
  ...
  founderStory: {
    ...
    image: "https://customer-assets.emergentagent.com/job_flight-buddy-2/artifacts/ad415i28_FD79B15E-B9C6-4077-B9BD-74F7F2E9BA28.PNG"
  },
...
export const mockHandlers = {
  joinMembership: (formData) => {
    console.log('Mock: Joining membership with data:', formData);
    return new Promise(resolve => {
      setTimeout(() => {
        resolve({ success: true, message: 'Welcome to JetSet 101!' });
      }, 1000);
    });
  },

  becomeAdvisor: (formData) => {
    console.log('Mock: Becoming advisor with data:', formData);
    return new Promise(resolve => {
      setTimeout(() => {
        resolve({ success: true, message: 'Advisor application submitted!' });
      }, 1000);
    });
  },
